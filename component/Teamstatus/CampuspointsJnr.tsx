...
function CampuspointsJnr() {
  ...
  return (
    <div className="bg-orange-50 flex flex-col h-screen pt-10 pb-10 ">
<div className="flex ml-5 justify-between mr-5">
    ...
    <h1 className="bg-red-700  rounded-lg w-fit px-2 font-semibold   text-white mb-5">After 50</h1>
    </div>
      {/* Top 3 Ranks */}
...
export default CampuspointsJnr;
