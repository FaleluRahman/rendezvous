...
const ProgramData = [
    ...
    {id:"46",name:"KITHABIC RESEARCH (BOOK WRITING ARABIC)",category:"senior"},
    ...
    {id:"246",name:"WRITTEN TRANSLATION  ARABI MAL - MAL",category:"junior"},
    ...
    {id:"276",name:"RISALA CREATION (BOOK WRITING ARABIC)",category:"junior"},
...
const ItemResult = () => {
  ...
  return (
    <div className="result mt-0 flex flex-wrap items-center justify-center w-full gap-5 bg-white p-5 mb-20" id="result">
        ...
        >
          ...
          {expandedItem === program.id && (
            <div className="w-full mx-auto bg-gradient-to-br from-[#ffffff] to-[#fffdee] py-5 border-t-2 border-red-400">
              {hasPrizeData(program.id) ? (
                getPrizeData(program.id)
