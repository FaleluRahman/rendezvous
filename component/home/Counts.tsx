...
const Counts = () => {
  return (
    <div className='bg-orange-50 grid grid-cols-2  grid-rows-3 px-5 py-4 w-full mx-auto text-center gap-2  '>
        ...
        <div className='bg-green-50  px-3 py-5 rounded-3xl relative  mx-1 leading-[14px] overflow-hidden row-span-2'>
            ...
            <img className='absolute w-20 h-20  bottom-[-12px] right-0 text-green-600 opacity-15 cursor-pointer' src="/image/jm-logo.png" alt="" />
