...
const Wallet = () => {
  return (
    <div className='bg-orange-50 pt-5 px-8 w-full flex pb-20 flex-col justify-center'>
    ...
    <div className='w-full relative bg-white rounded-3xl flex flex-col overflow-hidden  pb-5 mb-4'>
      ...
      <div className='text-zinc-800 font-bold flex w-full justify-between px-5 pt-1'>
        <p>Collect More Points</p>
              ...
              <button className='bg-yellow-300/65 ml-5 text-zinc-700 w-fit pr-36 font-bold px-3 py-1 rounded-2xl'>Collect</button>
