...
const Wallet = () => {
  return (
    ...
    <div className='text-zinc-700  flex-col flex w-full px-5 pt-5'>
      <p className='font-bold text-[10px]'>Collect More Points</p>
      <p className='text-[10px] w-90 mx-auto text-justify leading-[-42px]'>Scan the QR code to earn points by participating in these sessions, and redeem them for delicious items at Cafe and reduction at book fair and various exhibitions</p>
